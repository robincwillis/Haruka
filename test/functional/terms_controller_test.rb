...
class TermsControllerTest < ActionController::TestCase
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post :create, term: { def: @term.def, desc: @term.desc, kana: @term.kana, kanji: @term.kanji, lit: @term.lit, name: @term.name }
    end
  ...
  test "should update term" do
    put :update, id: @term, term: { def: @term.def, desc: @term.desc, kana: @term.kana, kanji: @term.kanji, lit: @term.lit, name: @term.name }
    assert_redirected_to term_path(assigns(:term))
  end
